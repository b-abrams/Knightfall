...
public class enemyDamage : MonoBehaviour {
	...
	public BoxCollider2D slash, thrust;
	...
	{
		if ((target.collider == slash && collider.IsTouching(target.collider)) || (target.collider == thrust && collider.IsTouching(target.collider)))
		{
			OnExplode();
		}
	}
